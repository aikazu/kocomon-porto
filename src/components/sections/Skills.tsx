            ...
            return (
              ...
              >
                ...
                <div className="relative h-full bg-void p-8 transition-colors duration-500">
                  ...
                  <div className="space-y-6">
                    {category.skills.map((skill) => (
                      <div key={skill.name} className="group/skill">
                        ...
                        <div className="flex gap-[2px] h-1.5" role="progressbar" aria-valuenow={skill.level} aria-valuemin={0} aria-valuemax={100} aria-label={`${skill.name} proficiency`}>
                  ...
                  <div aria-hidden="true" className="mt-8 pt-4 border-t border-white/5 flex justify-between items-center">
